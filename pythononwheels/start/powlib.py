...
taken from: http://code.activestate.com/recipes/306864-list-and-dictionary-observer/
...
class list_observer(list):
    ...
    def __init__ (self,value,observer, name):
    ...
    def __setitem__ (self,key,value):
        ...
        try:
            ...
            self.observer._changed(name=self.name)
